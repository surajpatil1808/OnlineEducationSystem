...
export class ApiService {
  ...
  postData(data: any) {
    return this._http.post<any>("https://educationapisu.azurewebsites.net/api/Lectures", data)
      .pipe(map((res: any) => {
        return res;
      }))
  }
  ...
  getData() {
    return this._http.get<any>("https://educationapisu.azurewebsites.net/api/Lectures")
      .pipe(map((res: any) => {
        return res;
      }))
  }
  ...
  deleteData(id: number) {
    return this._http.delete<any>("https://educationapisu.azurewebsites.net/api/Lectures/" + id)
      .pipe(map((res: any) => {
        return res;
      }))
  }
  ...
  updateData(data: any, id: number) {
    console.log('api updating');
    return this._http.put<any>("https://educationapisu.azurewebsites.net/api/Lectures/" + id, data)
      .pipe(map((res: any) => {
        console.log('api updated...');
        return res;
      }))
  ...
  postDa(data: any) {
    return this._http.post<any>("https://educationapisu.azurewebsites.net/api/Studentdashboards", data)
      .pipe(map((res: any) => {
        return res;
      }))
  }
  ...
  getDa() {
    return this._http.get<any>("https://educationapisu.azurewebsites.net/api/Studentdashboards")
      .pipe(map((res: any) => {
        return res;
      }))
  }
  ...
  deleteDa(id: number) {
    return this._http.delete<any>("https://educationapisu.azurewebsites.net/api/Studentdashboards/" + id)
      .pipe(map((res: any) => {
        return res;
      }))
  }
  ...
  updateDa(data: any, id: number) {
    console.log('api updating');
    return this._http.put<any>("https://educationapisu.azurewebsites.net/api/Studentdashboards/" + id, data)
      .pipe(map((res: any) => {
        console.log('api updated...');
        return res;
      }))
